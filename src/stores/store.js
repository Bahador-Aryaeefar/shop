...
// singleton pattern: one instance of Toast
export const store = new Vuex.Store({
    ...
    mutations: {
        ...
        changeShipping: (state, productId) => {
            //find the product in the cart list
            let cartProduct = state.cart.find((product) => product.id === productId);

            cartProduct.fast = !cartProduct.fast;
    ...
    actions: {
        ...
        changeShipping: ({ commit }, productId) => {
            myApi.products("changeShipping", productId).then((productId) => {
                commit("changeShipping", productId);
                commit("showToast", "changed shipping");
            });
        }
    }
});